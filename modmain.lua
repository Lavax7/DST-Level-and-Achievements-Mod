...
PrefabFiles = {"seffc", "klaussack_placer", "altar_placer", "pigking", "antlion", "shadowwaxwell",
               "perkportableblender", "perkportablecookpot", "perkportablespicer"}

_G.SECONDRUN = GetModConfigData('SECOND')

Assets = {Asset("ATLAS", "images/inventoryimages/klaussack.xml"),
          ...
          Asset("ATLAS", "images/inventoryimages/altar.xml"), Asset("IMAGE", "images/inventoryimages/altar.tex"),

          Asset("ATLAS", "images/hud/background_lmod.xml"), Asset("IMAGE", "images/hud/background_lmod.tex"),
          Asset("ATLAS", "images/hud/background_info.xml"), Asset("IMAGE", "images/hud/background_info.tex"),
          Asset("ATLAS", "images/hud/star.xml"), Asset("IMAGE", "images/hud/star.tex"),
          Asset("ATLAS", "images/hud/reset_info.xml"), Asset("IMAGE", "images/hud/reset_info.tex"),
          Asset("ATLAS", "images/hud/xpbar_empty.xml"), Asset("IMAGE", "images/hud/xpbar_empty.tex"),
          Asset("ATLAS", "images/hud/levelbadge.xml"), Asset("IMAGE", "images/hud/levelbadge.tex"),
          Asset("ATLAS", "images/hud/xpbar_filled.xml"), Asset("IMAGE", "images/hud/xpbar_filled.tex"),

          Asset("ATLAS", "images/button/perk.xml"), Asset("IMAGE", "images/button/perk.tex"),
          Asset("ATLAS", "images/button/perk_active.xml"), Asset("IMAGE", "images/button/perk_active.tex"),
          Asset("ATLAS", "images/button/button_bg.xml"), Asset("IMAGE", "images/button/button_bg.tex"),
          Asset("ATLAS", "images/button/button_bg_inactive.xml"),
          Asset("IMAGE", "images/button/button_bg_inactive.tex"), Asset("ATLAS", "images/button/achievement.xml"),
          Asset("IMAGE", "images/button/achievement.tex"), Asset("ATLAS", "images/button/achievement_active.xml"),
          Asset("IMAGE", "images/button/achievement_active.tex"), Asset("ATLAS", "images/button/checkbutton.xml"),
          Asset("IMAGE", "images/button/checkbutton.tex"), Asset("ATLAS", "images/button/coinbutton.xml"),
          Asset("IMAGE", "images/button/coinbutton.tex"), Asset("ATLAS", "images/button/config_act.xml"),
          Asset("IMAGE", "images/button/config_act.tex"), Asset("ATLAS", "images/button/config_bg.xml"),
          Asset("IMAGE", "images/button/config_bg.tex"), Asset("ATLAS", "images/button/config_bigger.xml"),
          Asset("IMAGE", "images/button/config_bigger.tex"), Asset("ATLAS", "images/button/config_smaller.xml"),
          Asset("IMAGE", "images/button/config_smaller.tex"), Asset("ATLAS", "images/button/config_language.xml"),
          Asset("IMAGE", "images/button/config_language.tex"), Asset("ATLAS", "images/button/levelplus.xml"),
          Asset("IMAGE", "images/button/levelplus.tex"), Asset("ATLAS", "images/button/mainbutton_bg.xml"),
          Asset("IMAGE", "images/button/mainbutton_bg.tex"), Asset("ATLAS", "images/button/mainbutton_bg_achieve.xml"),
          Asset("IMAGE", "images/button/mainbutton_bg_achieve.tex"), -----Tab
Asset("ATLAS", "images/inventoryimages/perk_tab.xml"), Asset("ANIM", "anim/altar.zip")}
AddMinimapAtlas("images/inventoryimages/altar.xml")

STRINGS.NAMES.PERK_TAB = "REWARD"
STRINGS.TABS.PERK_TAB = "Rewards"
GLOBAL.RECIPETABS['PERK_TAB'] = {
    str = "PERK_TAB",
    sort = 25,
    icon = "perk_tab.tex",
    icon_atlas = "images/inventoryimages/perk_tab.xml"
}
...
local horti = AddRecipe("book_horticulture_perk",
    {Ingredient("papyrus", 2), Ingredient("seeds", 5), Ingredient("poop", 5)}, GLOBAL.RECIPETABS.PERK_TAB, TECH.NONE,
    nil, nil, nil, nil, "achivbookbuilder")
...
local catapult = AddRecipe("winona_catapult_perk",
    {Ingredient("sewing_tape", 1), Ingredient("twigs", 8), Ingredient("rocks", 20)}, GLOBAL.RECIPETABS.PERK_TAB,
    TECH.NONE, "winona_catapult_placer", TUNING.WINONA_ENGINEERING_SPACING, nil, nil, "engineering")
...
local spotlight = AddRecipe("winona_spotlight_perk",
    {Ingredient("sewing_tape", 1), Ingredient("goldnugget", 4), Ingredient("fireflies", 1)}, GLOBAL.RECIPETABS.PERK_TAB,
    TECH.NONE, "winona_spotlight_placer", TUNING.WINONA_ENGINEERING_SPACING, nil, nil, "engineering")
...
local generator = AddRecipe("winona_battery_low_perk",
    {Ingredient("sewing_tape", 1), Ingredient("log", 4), Ingredient("nitre", 4)}, GLOBAL.RECIPETABS.PERK_TAB, TECH.NONE,
    "winona_battery_low_placer", TUNING.WINONA_ENGINEERING_SPACING, nil, nil, "engineering")
...
local gemerator = AddRecipe("winona_battery_high_perk",
    {Ingredient("sewing_tape", 1), Ingredient("boards", 4), Ingredient("transistor", 2)}, GLOBAL.RECIPETABS.PERK_TAB,
    TECH.NONE, "winona_battery_high_placer", TUNING.WINONA_ENGINEERING_SPACING, nil, nil, "engineering")
...
-- Shrines
local perk_festive_gobbler = AddRecipe("perdshrine_perk", {Ingredient("goldnugget", 8), Ingredient("boards", 2),
                                                           Ingredient("berries", 3)}, GLOBAL.RECIPETABS.PERK_TAB,
    TECH.NONE, "perdshrine_placer", nil, nil, nil, "shrine")
...
local perk_festive_varg = AddRecipe("wargshrine_perk", {Ingredient("goldnugget", 8), Ingredient("boards", 2),
                                                        Ingredient("monstermeat", 4)}, GLOBAL.RECIPETABS.PERK_TAB,
    TECH.NONE, "wargshrine_placer", nil, nil, nil, "shrine")
...
local perk_festive_pig = AddRecipe("pigshrine_perk",
    {Ingredient("goldnugget", 8), Ingredient("boards", 2), Ingredient("pigskin", 2)}, GLOBAL.RECIPETABS.PERK_TAB,
    TECH.NONE, "pigshrine_placer", nil, nil, nil, "shrine")
...
local perk_festive_lab = AddRecipe("madscience_lab_perk",
    {Ingredient("transistor", 2), Ingredient("cutstone", 2), Ingredient("phlegm", 1)}, GLOBAL.RECIPETABS.PERK_TAB,
    TECH.NONE, "madscience_lab_placer", nil, nil, nil, "shrine")
...
local perk_festive_bag = AddRecipe("candybag_perk", {Ingredient("cutgrass", 6)}, GLOBAL.RECIPETABS.PERK_TAB, TECH.NONE,
    nil, nil, nil, nil, "shrine")
...
local perk_festive_wrap = AddRecipe("giftwrap_perk",
    {Ingredient("papyrus", 2), Ingredient("rope", 1), Ingredient("petals", 1)}, GLOBAL.RECIPETABS.PERK_TAB, TECH.NONE,
    nil, nil, nil, nil, "shrine")
...
---WORMWOOD Items
local livinglog = AddRecipe("livinglog_perk",
    {Ingredient(GLOBAL.CHARACTER_INGREDIENT.HEALTH, 25), Ingredient("log", 1)}, GLOBAL.RECIPETABS.PERK_TAB, TECH.NONE,
    nil, nil, nil, nil, "naturalist")
...
local compostwrap = AddRecipe("compostwrap_perk",
    {Ingredient("poop", 6), Ingredient("spoiled_food", 3), Ingredient("nitre", 2)}, GLOBAL.RECIPETABS.PERK_TAB,
    TECH.NONE, nil, nil, nil, nil, "naturalist")
...
AddRecipe("ancient_altar", {Ingredient("thulecite", 15), Ingredient("cutstone", 20), Ingredient("purplegem", 2)},
    GLOBAL.RECIPETABS.PERK_TAB, TECH.NONE, "ancient_altar_placer", -- placer
    nil, -- min_spacing
    nil, -- nounlock
    nil, -- numtogive
...
AddRecipe("klaus_sack", {Ingredient("redmooneye", 1), Ingredient("bluemooneye", 1), Ingredient("silk", 8)},
    GLOBAL.RECIPETABS.PERK_TAB, TECH.NONE, "klaussack_placer", -- placer
    nil, -- min_spacing
    nil, -- nounlock
    nil, -- numtogive
...
AddPlayerPostInit(function(inst)
    ...
    if GLOBAL.STRINGS.CHARACTERS[name] then
        ...
        if GLOBAL.STRINGS.CHARACTERS[name].ACTIONFAIL and GLOBAL.STRINGS.CHARACTERS[name].ACTIONFAIL['COOK'] and
            GLOBAL.STRINGS.CHARACTERS[name].ACTIONFAIL['COOK']['GENERIC'] then
...
AddComponentPostInit("crop", function(self)
    ...
    self.Harvest = function(self, harvester)
        ...
        if ret and product and harvester and pos and harvester.components.allachivcoin and
            harvester.components.allachivcoin.pickmaster then
...
local function NewQuickAction(inst, action)
    if action.target ~= nil and action.target.prefab == "berrybush_juicy" then
...
if GLOBAL.TUNING.TELEPORTATOMOD then
    ...
    GLOBAL.TUNING.TELEPORTATOMOD.functionsavewithteleportato =
        function(player) -- called for server
            local mods_data = {}
    ...
    AddPlayerPostInit(function(player)
        player:ListenForEvent("teleportatojumpLoadData", function(player, mods_data) -- load the mods_data
            if mods_data ~= nil and mods_data["achievementsMod"] ~= nil and mods_data["levelMod"] ~= nil and
                mods_data["achievementEvents"] ~= nil then -- you can add a modsetting if sth should be loaded or not
                _G.CAVES_CONFIG = GetModConfigData('CAVES')
                _G.MULT_CONFIG = GetModConfigData('MULT')
                _G.REFUND_CONFIG = GetModConfigData('REFUND')
                _G.SYSTEM_CONFIG = GetModConfigData('SYSTEM')
