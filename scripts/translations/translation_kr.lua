...
STRINGS.GUI = {
    ...
    ["close"] = "닫기",
    ["reset"] = "초기화",
    ["resetAchievments"] = "리셋 할 경우 모든 업그레이드가 지워지며, 그중 " ..
        math.ceil(reset_refund_percentage * 100) .. "%의 레벨 포인트를 돌려 받습니다.",
    ["food"] = "음식",
    ["life"] = "인생",
    ["work"] = "행동",
    ["have"] = "소유",
    ...
    ["attributeunits"] = "\n\n%\n%\n%\n\n\n",
    ["resetlevel"] = "리셋 할 경우, 모든 업그레이드가 지워지며,  그중 " ..
        math.ceil(reset_refund_percentage * 100) .. "%의 업적 포인트를 돌려 받습니다.",
...
STRINGS.ACHIEVEMENTS = {
    ...
    ["eatcold"] = {
        ...
        ["info"] = "님이 " .. allachiv_eventdata["eatcold"] ..
            " 번 음식을 먹어 추위에서 탈출했습니다!"
    },
    ["eatfish"] = {
        ["name"] = "생선튀김 마니아",
    ...
    ["sleepsiesta"] = {
        ...
        ["info"] = "님이 낮잠용 오두막에서 " .. allachiv_eventdata["sleepsiesta"] ..
            " 번 잠들었습니다!"
    },
    ["reviveamulet"] = {
        ["name"] = "생명줄",
    ...
    ["dmgnodmg"] = {
        ["name"] = "카이팅 전문",
        ["description"] = "모든 공격을 피하며 " .. (allachiv_eventdata["dmgnodmg"] / 1000) ..
            "만큼의 데미지를 입히세요",
        ["info"] = "님이 카이팅을 하며 " .. allachiv_eventdata["dmgnodmg"] ..
            "만큼 데미지를 입혔습니다!"
    },
    ["bullkelp"] = {
        ["name"] = "찰싹찰싹",
        ["description"] = "황소다시마 줄기로 " .. (allachiv_eventdata["bullkelp"] / 1000) ..
            "만큼 데미지를 입히세요",
        ["info"] = "님이 황소다시마 줄기로 " .. allachiv_eventdata["bullkelp"] ..
            " 만큼 데미지를 입혔습니다!"
    },
    ["butcher"] = {
        ["name"] = "도살자",
    ...
    ["fruitdragon"] = {
        ...
        ["info"] = "님이 빨간 샐러도마뱀 " .. allachiv_eventdata["fruitdragon"] ..
            " 마리를 죽였습니다!"
    },
    ["sick"] = {
        ["name"] = "소시오패스",
    ...
    ["fullsanity"] = {
        ["name"] = "강철멘탈",
        ["description"] = "" .. (allachiv_eventdata["fullsanity"] / 60) ..
            " 분동안 정신력 95% 이상을 유지하세요",
        ["info"] = "님이 " .. (allachiv_eventdata["fullsanity"] / 60) ..
            " 분동안 높은 정신력을 유지했습니다!"
    },
    ["fullhunger"] = {
        ["name"] = "don't starve together",
        ["description"] = "" .. (allachiv_eventdata["fullhunger"] / 60) ..
            " 분동안 허기 95% 이상을 유지하세요 ",
        ["info"] = "님이 " .. (allachiv_eventdata["fullhunger"] / 60) ..
            " 분동안 배부른 상태를 유지했습니다!"
    },
    ["pacifist"] = {
        ["name"] = "평화주의자",
        ["description"] = "" .. (allachiv_eventdata["pacifist"] / 60) .. " 분동안 아무도 해치지 마세요",
        ["info"] = "님이 " .. (allachiv_eventdata["pacifist"] / 60) ..
            " 분동안 아무도 해치지 않았습니다!"
    },
    ["allgiantPlants"] = {
        ["name"] = "많을수록 좋아",
...
STRINGS.PERKS = {
    ...
    ["hungerrateup"] = {
        ["name"] = "허기 감소 -",
        ["description"] = "허기감소율을 " .. (math.ceil(allachiv_coindata["hungerrateup"] * 100)) ..
            "% 줄입니다"
    },
    ["sanityregen"] = {
        ["name"] = "정신력 재생 +",
    ...
    ["crit"] = {
        ["name"] = "치명타 +",
        ["description"] = "치명타 확률을 " .. (math.ceil(allachiv_coindata["crit"] * 100)) ..
            "%  증가시킵니다"
    },
    ["lifesteal"] = {
        ["name"] = "흡혈 +",
        ["description"] = "준 데미지의  " .. (math.ceil(allachiv_coindata["lifesteal"] * 1000) / 10) ..
            "% 를 회복합니다"
    },
    ["scale"] = {
        ["name"] = "크기 +",
        ["description"] = "캐릭터의 크기가 " .. (math.ceil(allachiv_coindata["scale"] * 100)) ..
            "%  증가합니다"
    },
    ["speedup"] = {
        ["name"] = "속도 +",
        ["description"] = "캐릭터의 속도가 " .. (math.ceil(allachiv_coindata["speedup"] * 100)) ..
            "% 증가합니다"
    },
    ["absorbup"] = {
        ["name"] = "방어력 +",
        ["description"] = "캐릭터의 방어력이  " .. (math.ceil(allachiv_coindata["absorbup"] * 100)) ..
            "% 증가합니다"
    },
    ["krampusxmas"] = {
        ["name"] = "크리스마스",
        ["description"] = "크람푸스 가방의 드랍률이 " .. (math.ceil(allachiv_coindata["krampusxmas"] * 100)) ..
            "% 증가합니다"
    },
    ["fireflylightup"] = {
        ["name"] = "발광레벨 +",
    ...
    ["cheatdeath"] = {
        ["name"] = "죽음 극복",
        ["description"] = "죽기 직전일때 일시 무적과 주변피해를 줍니다! 쿨타임 : " ..
            (allachiv_coindata["cheatdeath"] / 60) .. " 분"
    },
    ["naturalist"] = {
        ["name"] = "웜우드 실직",
