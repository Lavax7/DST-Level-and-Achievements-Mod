...
STRINGS.GUI = {
    ...
    ["close"] = "Close",
    ["reset"] = "Reset",
    ["resetAchievments"] = "Resetting will remove all rewards and refund " .. math.ceil(reset_refund_percentage * 100) ..
        "% of achievement points. You also get a temporary health penalty.",
    ["food"] = "Food",
    ["life"] = "Life",
    ["work"] = "Work",
    ["have"] = "Have",
    ...
    ["attributeunits"] = "\n\n%\n%\n%\n\n\n",
    ["resetlevel"] = "Resetting will remove all upgrades and refund " .. math.ceil(reset_refund_percentage * 100) ..
        "% points. You also get a temporary health penalty.",
