local assets = {Asset("ANIM", "anim/perd_basic.zip"), Asset("ANIM", "anim/perd.zip"), Asset("SOUND", "sound/perd.fsb")}

local prefabs = {"drumstick", "redpouch"}
...
local function OnEat(inst, food)
    ...
    if IsSpecialEventActive(SPECIAL_EVENTS.YOTG) or specialEventActive == true then
        ...
        if food.components.inventoryitem ~= nil and not food.components.inventoryitem:IsHeld() and
