...
local uiachievement = Class(Widget, function(self, owner)
    ...
    self.mainui.achievement_bg.info = self.mainui.achievement_bg:AddChild(
        Image("images/hud/background_info.xml", "background_info.tex"))
    ...
    self.mainui.achievement_bg.coinamount = self.mainui.achievement_bg:AddChild(
        Text(NUMBERFONT, 45, self.owner.currentcoinamount:value()))
    ...
    self.mainui.achievement_bg.close = self.mainui.achievement_bg:AddChild(
        ImageButton("images/button/button_bg.xml", "button_bg.tex"))
    ...
    self.mainui.achievement_bg.reset = self.mainui.achievement_bg:AddChild(
        ImageButton("images/button/button_bg.xml", "button_bg.tex"))
    ...
    self.mainui.removeinfo.removeyes = self.mainui.removeinfo:AddChild(
        ImageButton("images/button/button_bg.xml", "button_bg.tex"))
    ...
    self.mainui.removeinfo.removeno = self.mainui.removeinfo:AddChild(
        ImageButton("images/button/button_bg.xml", "button_bg.tex"))
    ...
    self.followhandler = TheInput:AddMoveHandler(function(x, y)
        if dragging then
            ...
            if y < screenh_full - threshold - margin then
                dragging = false
            end
            local pos
    ...
    self.mainbutton.checkbutton = self.mainbutton:AddChild(ImageButton("images/button/checkbutton.xml",
        "checkbutton.tex"))
    self.mainbutton.checkbutton:MoveToFront()
    self.mainbutton.checkbutton:SetHoverText(STRINGS.GUI["viewA"], {
        size = 9,
        offset_x = 90,
        offset_y = -55,
        colour = {1, 1, 1, 1}
    ...
    self.mainbutton.coinbutton:SetHoverText(STRINGS.GUI["viewR"], {
        size = 9,
        offset_x = 15,
        offset_y = -55,
        colour = {1, 1, 1, 1}
    ...
    self.mainbutton.configact:SetHoverText(STRINGS.GUI["set"], {
        size = 9,
        offset_x = 0,
        offset_y = -55,
        colour = {1, 1, 1, 1}
    ...
    self.mainbutton.configbigger = self.mainbutton:AddChild(ImageButton("images/button/config_bigger.xml",
        "config_bigger.tex"))
    ...
    self.mainbutton.configbigger:SetHoverText(STRINGS.GUI["zoomI"], {
        size = 9,
        offset_x = 0,
        offset_y = -55,
        colour = {1, 1, 1, 1}
    ...
    self.mainbutton.configsmaller = self.mainbutton:AddChild(
        ImageButton("images/button/config_smaller.xml", "config_smaller.tex"))
    ...
    self.mainbutton.configsmaller:SetHoverText(STRINGS.GUI["zoomO"], {
        size = 9,
        offset_x = 0,
        offset_y = -55,
        colour = {1, 1, 1, 1}
    ...
    self.mainbutton.configlanguage = self.mainbutton:AddChild(
        ImageButton("images/button/config_language.xml", "config_language.tex"))
    ...
    self.mainbutton.configlanguage:SetHoverText(STRINGS.GUI["changeL"], {
        size = 9,
        offset_x = 0,
        offset_y = -55,
        colour = {1, 1, 1, 1}
    ...
    for i, language in ipairs(languagelist) do
        languagebuttons[i] = self.mainbutton.languages:AddChild(
            ImageButton("images/button/levelplus.xml", "levelplus.tex"))
    ...
    self.mainui.infobutton.cat1 = self.mainui.infobutton:AddChild(
        ImageButton("images/button/button_bg_inactive.xml", "button_bg_inactive.tex"))
    ...
    self.mainui.infobutton.cat2 = self.mainui.infobutton:AddChild(
        ImageButton("images/button/button_bg_inactive.xml", "button_bg_inactive.tex"))
    ...
    self.mainui.infobutton.cat3 = self.mainui.infobutton:AddChild(
        ImageButton("images/button/button_bg_inactive.xml", "button_bg_inactive.tex"))
    ...
    self.mainui.infobutton.cat4 = self.mainui.infobutton:AddChild(
        ImageButton("images/button/button_bg_inactive.xml", "button_bg_inactive.tex"))
    ...
    self.mainui.infobutton.cat5 = self.mainui.infobutton:AddChild(
        ImageButton("images/button/button_bg_inactive.xml", "button_bg_inactive.tex"))
    ...
    self.mainui.infobutton.cat6 = self.mainui.infobutton:AddChild(
        ImageButton("images/button/button_bg_inactive.xml", "button_bg_inactive.tex"))
    ...
    self.mainui.infobutton.cat7 = self.mainui.infobutton:AddChild(
        ImageButton("images/button/button_bg_inactive.xml", "button_bg_inactive.tex"))
    ...
    self.mainui.infobutton.cat8 = self.mainui.infobutton:AddChild(
        ImageButton("images/button/button_bg_inactive.xml", "button_bg_inactive.tex"))
    ...
    self.mainui.infobutton.cat9 = self.mainui.infobutton:AddChild(
        ImageButton("images/button/button_bg_inactive.xml", "button_bg_inactive.tex"))
    ...
    self.mainui.infobutton.cat10 = self.mainui.infobutton:AddChild(
        ImageButton("images/button/button_bg_inactive.xml", "button_bg_inactive.tex"))
    ...
    self.mainui.infobutton.cat11 = self.mainui.infobutton:AddChild(
        ImageButton("images/button/button_bg_inactive.xml", "button_bg_inactive.tex"))
    ...
    -- Buttons
    self.mainui.perk_cat.perkcat1 = self.mainui.perk_cat:AddChild(
        ImageButton("images/button/button_bg_inactive.xml", "button_bg_inactive.tex"))
    ...
    self.mainui.perk_cat.perkcat2 = self.mainui.perk_cat:AddChild(
        ImageButton("images/button/button_bg_inactive.xml", "button_bg_inactive.tex"))
    ...
    self.mainui.perk_cat.perkcat3 = self.mainui.perk_cat:AddChild(
        ImageButton("images/button/button_bg_inactive.xml", "button_bg_inactive.tex"))
    ...
    self.mainui.levelbg.xpbar_empty = self.mainui.levelbg:AddChild(
        Image("images/hud/xpbar_empty.xml", "xpbar_empty.tex"))
    ...
    self.mainui.levelbg.xpbar_filled = self.mainui.levelbg:AddChild(
        Image("images/hud/xpbar_filled.xml", "xpbar_filled.tex"))
    ...
    self.mainui.levelbg.reset =
        self.mainui.levelbg:AddChild(ImageButton("images/button/button_bg.xml", "button_bg.tex"))
    ...
    self.mainui.removeinfoXP.removeyes = self.mainui.removeinfoXP:AddChild(
        ImageButton("images/button/button_bg.xml", "button_bg.tex"))
    ...
    self.mainui.removeinfoXP.removeno = self.mainui.removeinfoXP:AddChild(
        ImageButton("images/button/button_bg.xml", "button_bg.tex"))
    ...
    self.mainui.levelbg.levelupbuttons.plushunger = self.mainui.levelbg.levelupbuttons:AddChild(ImageButton(
        "images/button/levelplus.xml", "levelplus.tex"))
    self.mainui.levelbg.levelupbuttons.plushunger:SetPosition(0, 0, 0)
    self.mainui.levelbg.levelupbuttons.plushunger.label = self.mainui.levelbg.levelupbuttons.plushunger:AddChild(Text(
        BODYTEXTFONT, 35))
    ...
    self.mainui.levelbg.levelupbuttons.plussanity = self.mainui.levelbg.levelupbuttons:AddChild(ImageButton(
        "images/button/levelplus.xml", "levelplus.tex"))
    self.mainui.levelbg.levelupbuttons.plussanity:SetPosition(0, -45, 0)
    self.mainui.levelbg.levelupbuttons.plussanity.label = self.mainui.levelbg.levelupbuttons.plussanity:AddChild(Text(
        BODYTEXTFONT, 35))
    ...
    self.mainui.levelbg.levelupbuttons.plushealth = self.mainui.levelbg.levelupbuttons:AddChild(ImageButton(
        "images/button/levelplus.xml", "levelplus.tex"))
    self.mainui.levelbg.levelupbuttons.plushealth:SetPosition(0, -90, 0)
    self.mainui.levelbg.levelupbuttons.plushealth.label = self.mainui.levelbg.levelupbuttons.plushealth:AddChild(Text(
        BODYTEXTFONT, 35))
    ...
    self.mainui.levelbg.levelupbuttons.plusdamage = self.mainui.levelbg.levelupbuttons:AddChild(ImageButton(
        "images/button/levelplus.xml", "levelplus.tex"))
    self.mainui.levelbg.levelupbuttons.plusdamage:SetPosition(0, -135, 0)
    self.mainui.levelbg.levelupbuttons.plusdamage.label = self.mainui.levelbg.levelupbuttons.plusdamage:AddChild(Text(
        BODYTEXTFONT, 35))
    ...
    self.mainui.levelbg.levelupbuttons.plusdefence = self.mainui.levelbg.levelupbuttons:AddChild(ImageButton(
        "images/button/levelplus.xml", "levelplus.tex"))
    self.mainui.levelbg.levelupbuttons.plusdefence:SetPosition(0, -180, 0)
    self.mainui.levelbg.levelupbuttons.plusdefence.label = self.mainui.levelbg.levelupbuttons.plusdefence:AddChild(Text(
        BODYTEXTFONT, 35))
    ...
    self.mainui.levelbg.levelupbuttons.plusspeed = self.mainui.levelbg.levelupbuttons:AddChild(ImageButton(
        "images/button/levelplus.xml", "levelplus.tex"))
    self.mainui.levelbg.levelupbuttons.plusspeed:SetPosition(0, -225, 0)
    self.mainui.levelbg.levelupbuttons.plusspeed.label = self.mainui.levelbg.levelupbuttons.plusspeed:AddChild(Text(
        BODYTEXTFONT, 35))
    ...
    self.mainui.levelbg.levelupbuttons.plusheat = self.mainui.levelbg.levelupbuttons:AddChild(ImageButton(
        "images/button/levelplus.xml", "levelplus.tex"))
    self.mainui.levelbg.levelupbuttons.plusheat:SetPosition(0, -270, 0)
    self.mainui.levelbg.levelupbuttons.plusheat.label = self.mainui.levelbg.levelupbuttons.plusheat:AddChild(Text(
        BODYTEXTFONT, 35))
    ...
    self.mainui.levelbg.levelupbuttons.pluscold = self.mainui.levelbg.levelupbuttons:AddChild(ImageButton(
        "images/button/levelplus.xml", "levelplus.tex"))
    self.mainui.levelbg.levelupbuttons.pluscold:SetPosition(0, -315, 0)
    self.mainui.levelbg.levelupbuttons.pluscold.label = self.mainui.levelbg.levelupbuttons.pluscold:AddChild(Text(
        BODYTEXTFONT, 35))
...
function uiachievement:updatepage(i)
    local active = ""
    if self.achivlist[i].check == 1 then
        active = "_active"
    end

    self.achivlisttile[i]:SetTexture("images/button/achievement" .. active .. ".xml", "achievement" .. active .. ".tex")

    if allachiv_eventdata[self.achivlist[i].name] ~= nil and self.achivlist[i].name ~= "king" and self.achivlist[i].name ~=
        "all" then
        self.achivlisttile[i]:SetHoverText(STRINGS.GUI["comp"] .. self.achivlist[i].current .. "/" ..
                                               allachiv_eventdata[self.achivlist[i].name])
    else
        self.achivlisttile[i]:SetHoverText(STRINGS.GUI["comp"] .. self.achivlist[i].check .. "/1")
    end
    if self.achivlist[i].name == "king" then
        self.achivlisttile[i]:SetHoverText(STRINGS.GUI["comp"] .. STRINGS.GUI["moose"] .. self.achivlist[i].current1 ..
                                               "  " .. STRINGS.GUI["ant"] .. self.achivlist[i].current2 .. "  " ..
                                               STRINGS.GUI["bear"] .. self.achivlist[i].current3 .. "  " ..
                                               STRINGS.GUI["deer"] .. self.achivlist[i].current4)
    end
    ...
    if self.achivlist[i].name == "alldiet" then
        ...
        self.mainui.achievement_bg.info.label:SetMultilineTruncatedString(self.achivlist[i].foodlist, 40, 250, 38,
            "...", true)
    end
    if self.achivlist[i].name == "allgiantPlants" then
        self.mainui.achievement_bg.info.header:SetString(STRINGS.GUI["giantPlantList"])
        self.mainui.achievement_bg.info.label:SetMultilineTruncatedString(self.achivlist[i].giantPlantList, 40, 250, 38,
            "...", true)
    end
...
function uiachievement:OnUpdate(dt)
    ...
    self.mainui.levelbg.levelxp:SetString(self.owner.currentlevelxp:value() .. "/" ..
                                              (math.min(levelxpcap, self.owner.currentlevel:value() * 100)))
    ...
    self.mainui.levelbg.attributelevels:SetString(
        hunger .. "\n" .. sanity .. "\n" .. health .. "\n" .. damage .. "\n" .. defence .. "\n" .. speed .. "\n" .. heat ..
            "\n" .. cold)
...
function uiachievement:buildpage(j, i)
    ...
    self.achivlisttile[i] = self.mainui.allachiv:AddChild(Image("images/button/achievement" .. active .. ".xml",
        "achievement" .. active .. ".tex"))
        ...
        self.achivlisttile[i].OnMouseButton = function(inst, button, down, x, y)
            if button == 1000 and down then
                if self.infoopen then
                    ...
                    self.mainui.achievement_bg.info.header:SetString(STRINGS.GUI["foodlist"])
                    self.mainui.achievement_bg.info.label:SetMultilineTruncatedString(self.achivlist[i].foodlist, 40,
                        250, 38, "...", true)
        ...
        self.achivlisttile[i].OnMouseButton = function(inst, button, down, x, y)
            if button == 1000 and down then
                if self.infoopenGiant then
                    ...
                    self.mainui.achievement_bg.info:Show()
                    self.mainui.achievement_bg.info.header:SetString(STRINGS.GUI["giantPlantList"])
                    self.mainui.achievement_bg.info.label:SetMultilineTruncatedString(self.achivlist[i].giantPlantList,
                        40, 250, 38, "...", true)
                    -- self.mainui.achievement_bg.info.label:SetString(self.achivlist[i].foodlist)
                    -- print(self.achivlist[i].foodlist)
                    for i = 1, 100 do
    ...
    if self.achivlist[i].name == "all" then
        self.achivlisttile[i].name:SetTruncatedString(STRINGS.ACHIEVEMENTS[self.achivlist[i].name]["name"] .. " " ..
                                                          self.achivlist[i].runcount + 1, 250, 500, "")
    else
    ...
    while #line < #STRINGS.ACHIEVEMENTS[self.achivlist[i].name]["description"] do
        ...
        self.achivlisttile[i].desc:SetTruncatedString(STRINGS.ACHIEVEMENTS[self.achivlist[i].name]["description"], 250,
            500, "")
        line = self.achivlisttile[i].desc:GetString()
    end
...
function uiachievement:build_perkpage(j, i, adaptivecost)
    ...
    self.coinlistbutton[i] = self.mainui.allcoin:AddChild(ImageButton("images/button/perk" .. active .. ".xml",
        "perk" .. active .. ".tex"))
    ...
    self.coinlistbutton[i].desc:SetMultilineTruncatedString(STRINGS.PERKS[self.coinlist[i].name]["description"], 2, 260,
        500, "", true)
